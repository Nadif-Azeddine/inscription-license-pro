    ...
    <div class="container py-4 pb-4 px-4">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 mb-3 mt-2">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <input id="prenom" type="text"
                                            value="{{ Auth::user()->prenom ?? old('prenom') }}"
                                            class="form-control @error('prenom') is-invalid @enderror" name="prenom"
                                            required placeholder="Entrer votre prenom" autofocus>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <input id="email" type="email"
                                            ...
                                            required autocomplete="email" placeholder="example@example.com" autofocus>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <input id="tel" type="tel" value="{{ Auth::user()->tel ?? old('tel') }}"
                                            class="form-control @error('tel') is-invalid @enderror" name="tel" required
                                            autocomplete="tel" placeholder="+212666666666" autofocus>
                    ...
                    @error('email')
                        <div class="modal fade show" id="modelerror" style="display: block; background: #4a4a4a65"
                            ...
                            <div class="modal-dialog modal-dialog-centered max-w-sm-100 w-px-400" role="document">
                                <div class="modal-content py-4 text-center shadow-lg"
                                    ...
                                    <div class="position-relative mb-2 text-center" style="z-index: 10">
                                        <button onclick="closeModal()" data-bs-dismiss="modal"
                                            class=" position-absolute end-0 top-0 py-2 px-3 rounded-circle text-white "><span><i
                                                    class="fa fa-x" aria-hidden="true"></i></span></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-4">
                                            <h2 class="modal-title fw-bold">ERROR</h2>
                                            <p class="text-danger">it seems that you already create an account, try to continue
                                                inscription instead</p>
                                        </div>
                ...
                <h1 class="fw-bold text-center">Bac Infos</h1>
            </div>
        </div>
    @endsection
    @section('scripts')
